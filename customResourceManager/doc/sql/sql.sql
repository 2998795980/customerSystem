...
CREATE TABLE IF NOT EXISTS `custom_resource_manager`.`permissions` (
  ...
  `resource_permissions` VARCHAR(45) NULL COMMENT '资源权限',
...
CREATE TABLE IF NOT EXISTS `custom_resource_manager`.`person` (
  ...
  `position` VARCHAR(32) NULL COMMENT '职位',
  `department` VARCHAR(32) NULL COMMENT '部门',
  `state` TINYINT NULL,
  `created_by` INT NULL,
  `created_time` DATETIME NULL,
  `updated_time` DATETIME NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `custom_resource_manager`.`view1` (`id` INT);
