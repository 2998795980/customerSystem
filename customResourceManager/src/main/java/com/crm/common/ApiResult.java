...
public class ApiResult<T> implements Serializable {
    ...
    public static <T> ApiResult<T> failed() {
        return result(ApiResultCode.SYSTEM_EXECUTION_ERROR.getCode(), ApiResultCode.SYSTEM_EXECUTION_ERROR.getMsg(),
            null);
    }
    ...
    public static <T> ApiResult<T> failed(ApiResultCode resultCode) {
        return result(resultCode.getCode(), resultCode.getMsg(), null);
    }

    public static <T> ApiResult<T> failed(ApiResultCode resultCode, String msg) {
        return result(resultCode.getCode(), msg, null);
    }

    private static <T> ApiResult<T> result(ApiResultCode resultCode, T data) {
